...
if [ ! -d "ik" ]; then
    ...
    mkdir ik
    $SUDO mv elasticsearch-analysis-ik-6.5.0.zip ./ik
    cd ik
    unzip elasticsearch-analysis-ik-6.5.0.zip
    $SUDO rm -rf elasticsearch-analysis-ik-6.5.0.zip
fi

$SUDO docker build -t 9d77v/elasticsearch:6.5.0 .
$SUDO docker push 9d77v/elasticsearch:6.5.0